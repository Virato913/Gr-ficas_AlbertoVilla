========================================================================
    APLICACIÓN DE CONSOLA: Gráficas_AlbertoVilla Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación Gráficas_AlbertoVilla.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación Gráficas_AlbertoVilla.


Gráficas_AlbertoVilla.vcxproj
...
Gráficas_AlbertoVilla.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado Gráficas_AlbertoVilla.pch y un archivo de tipos precompilados llamado StdAfx.obj.
